...
###### \- \\(H\_r\\) is the latent workspace at reasoning step \\(r\\),

###### \- \\(S\_K\\) is the memory state after processing demonstrations,

###### \- \\(F\_\\theta\\) is the recurrent computation.
...
###### S\_t=(1-\\gamma)S\_{t-1}+\\eta(A\_tB\_t^T)
...
###### \- \\(S\_t\\) = memory state at step \\(t\\)

###### \- \\(\\gamma\\) = decay factor

###### \- \\(\\eta\\) = plasticity/update rate

###### \- \\(A\_t,B\_t\\) = encoded demonstration representations
...
###### results/controlled\_evaluation.csv
...
###### .venv\\Scripts\\python.exe -m backend.experiments.controlled\_evaluation
...
###### │   ├── controlled\_evaluation.csv

###### │   ├── ablation\_memory\_reasoning.csv
...
###### │   └── experiment\_result.schema.json
...
###### \- \*\*Live Demo:\*\* `YOUR\_PUBLIC\_DEMO\_URL`

###### \- \*\*Source Code:\*\* `YOUR\_PUBLIC\_GITHUB\_URL`

###### \- \*\*Technical Blog / Report:\*\* `YOUR\_PUBLIC\_REPORT\_URL`
